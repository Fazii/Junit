public interface IMatrixMath {
  ...
  IMatrix	inverseMatrix(IMatrix m1) throws InvalidDimensionException;
  ...
  IMatrix	scalarMultiplication(IMatrix m1, double scalar) throws InvalidDimensionException;
}
